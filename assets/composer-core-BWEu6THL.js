...
`):`<p class="text-sm cf-muted">No decision variables yet.</p>`}
      ...
      `}}};function T(e){return ue[e]||null}var de={content:`Content & Media`,assessment:`Assessment & Knowledge`,interactive:`Interactive Activities`,productivity:`Reports & Save/Load`,layout:`Layout & Utility`,general:`Other`},fe={content_block:`content`,title_block:`content`,spacer_block:`layout`,embed_block:`content`,image_block:`content`,resource_list:`content`,assessment_embed:`assessment`,rubric_creator:`assessment`,knowledge_check:`assessment`,submission_builder:`productivity`,save_load_block:`productivity`,callout_block:`content`,accordion_block:`content`,tabs_block:`content`,tab_group:`layout`,card_list:`layout`,step_sequence:`content`,checklist_block:`interactive`,scenario_branch:`interactive`,drag_sort_block:`interactive`,flashcard_deck:`interactive`,reflection_journal:`interactive`,worksheet_form:`assessment`,fillable_chart:`interactive`,portfolio_evidence:`assessment`,path_map:`interactive`,hotspot_image:`interactive`,timeline_story:`content`,before_after:`interactive`,roleplay_simulator:`interactive`,decision_lab:`interactive`};function pe(e){return fe[e]||`general`}function me(e){return de[e]||de.general}function he(){return Object.keys(ue)}function ge(){let e={};return Object.keys(ue).forEach(t=>{let n=pe(t);e[n]||(e[n]=[]),e[n].push(t)}),[`content`,`assessment`,`interactive`,`productivity`,`layout`,`general`].filter(t=>Array.isArray(e[t])&&e[t].length>0).map(t=>({category:t,label:me(t),types:e[t]}))}function _e(e=``){return String(e||``).replace(/<style[\s\S]*?<\/style>/gi,` `).replace(/<script[\s\S]*?<\/script>/gi,` `).replace(/<[^>]*>/g,` `).replace(/&nbsp;/gi,` `).replace(/&#39;/gi,`'`).replace(/&quot;/gi,`"`).replace(/&amp;/gi,`&`).replace(/&lt;/gi,`<`).replace(/&gt;/gi,`>`).replace(/\s+/g,` `).trim()}function ve(e,t=`item`){return String(e||``).trim().toLowerCase().replace(/<[^>]*>/g,``).replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||t}function E(e,t=[]){return typeof e==`string`?((/[<][a-z!/]/i.test(e)||/\bhref\s*=\s*["']#/i.test(e)||/\bid\s*=\s*["']/i.test(e))&&t.push(e),t):Array.isArray(e)?(e.forEach(e=>E(e,t)),t):(e&&typeof e==`object`&&Object.values(e).forEach(e=>E(e,t)),t)}function ye(e=``){let t=new Set,n=/\sid\s*=\s*(['"])(.*?)\1/gi,r=n.exec(String(e||``));for(;r;){let i=String(r[2]||``).trim();i&&t.add(i),r=n.exec(String(e||``))}return t}function be(e=``){let t=new Set,n=/\shref\s*=\s*(['"])#(.*?)\1/gi,r=n.exec(String(e||``));for(;r;){let i=String(r[2]||``).trim();i&&t.add(i),r=n.exec(String(e||``))}return t}function xe(e=``){let t=0,n=/<h([1-6])[^>]*>([\s\S]*?)<\/h\1>/gi,r=n.exec(String(e||``));for(;r;)_e(r[2]||``)||(t+=1),r=n.exec(String(e||``));return t}function Se(e){let t=String(e||``).trim();if(!t)return null;let n=t.match(/^#([0-9a-f]{3}|[0-9a-f]{6})$/i);if(n){let e=n[1].length===3?n[1].split(``).map(e=>`${e}${e}`).join(``):n[1];return{r:Number.parseInt(e.slice(0,2),16),g:Number.parseInt(e.slice(2,4),16),b:Number.parseInt(e.slice(4,6),16)}}let r=t.match(/^rgba?\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})(?:\s*,\s*(0|0?\.\d+|1(?:\.0+)?))?\s*\)$/i);return r?{r:Math.max(0,Math.min(255,Number.parseInt(r[1],10)||0)),g:Math.max(0,Math.min(255,Number.parseInt(r[2],10)||0)),b:Math.max(0,Math.min(255,Number.parseInt(r[3],10)||0))}:null}function D(e){let t=e/255;return t<=.03928?t/12.92:((t+.055)/1.055)**2.4}function Ce(e,t){if(!e||!t)return 0;let n=.2126*D(e.r)+.7152*D(e.g)+.0722*D(e.b),r=.2126*D(t.r)+.7152*D(t.g)+.0722*D(t.b),i=Math.max(n,r),a=Math.min(n,r);return(i+.05)/(a+.05)}function we(e,t){let n=String(e?.id||``).trim(),r=new Set,i=`activity-${t+1}`;return n&&(r.add(n),r.add(`cf-activity-${ve(n,i)}`),r.add(`cb-${ve(n,`section-${t+1}`)}`)),E(e?.data||{}).forEach(e=>{ye(e).forEach(e=>r.add(e))}),e?.type===`card_list`&&(Array.isArray(e?.data?.cards)?e.data.cards:[]).forEach((e,t)=>{r.add(`${ve(n,`card-list`)}-panel-${t+1}`)}),r}function Te(e){let t=[],n=e?.type||``,r=e?.data&&typeof e.data==`object`?e.data:{},i=e=>{let t=String(e||``).trim();return!t||/^javascript:/i.test(t)?!1:/^(https?:)?\/\//i.test(t)||/^(\/|\.\/|\.\.\/)/.test(t)||/^(blob:|data:)/i.test(t)||/^(assets|materials)\//i.test(t)?!0:/\s/.test(t)?!1:t.includes(`/`)||/\.[a-z0-9]{2,8}($|[?#])/i.test(t)},a=(e,n)=>{t.push({level:e===`error`?`error`:`warn`,message:String(n||``).trim()})};if(!n||!T(n))return a(`error`,`Unknown activity type: ${n||`(missing)`}`),t;if(n===`embed_block`&&(String(r.url||``).trim()||a(`error`,`Embed URL is missing.`),String(r.url||``).trim()&&!i(r.url)&&a(`warn`,`Embed URL format looks invalid.`)),n===`image_block`&&(String(r.url||``).trim()||a(`error`,`Image URL is missing.`),String(r.url||``).trim()&&!i(r.url)&&a(`warn`,`Image URL format looks invalid.`),String(r.alt||``).trim()||a(`warn`,`Alt text is empty (accessibility).`)),n===`title_block`&&(_e(r.textHtml||r.text||``)||a(`warn`,`Title block content is empty.`)),n===`content_block`&&(_e(r.bodyHtml||r.body||``)||a(`warn`,`Content block body is empty.`)),n===`resource_list`){let e=Array.isArray(r.items)?r.items:[];String(r.title||``).trim()||a(`warn`,`Resource list title is empty.`),e.length===0&&a(`warn`,`No resources added yet.`),e.forEach((e,t)=>{let n=String(e?.label||``).trim(),r=String(e?.viewUrl||e?.url||``).trim(),o=String(e?.downloadUrl||e?.url||``).trim(),s=!!e?.digitalContent;n||a(`warn`,`Resource #${t+1}: label is empty.`),!r&&!o&&!s&&a(`warn`,`Resource #${t+1}: missing view/download/read source.`),r&&!i(r)&&a(`warn`,`Resource #${t+1}: view URL format looks invalid.`),o&&!i(o)&&a(`warn`,`Resource #${t+1}: download URL format looks invalid.`)})}if(n===`rubric_creator`){let e=d(r.rowCount,3),t=d(r.colCount,3);String(r.title||``).trim()||a(`warn`,`Rubric title is empty.`),r.rowCount!=null&&d(r.rowCount,3)!==Number.parseInt(r.rowCount,10)&&a(`warn`,`Rubric row count is clamped to ${e} (allowed ${l}-${u}).`),r.colCount!=null&&d(r.colCount,3)!==Number.parseInt(r.colCount,10)&&a(`warn`,`Rubric column count is clamped to ${t} (allowed ${l}-${u}).`);let n=Array.isArray(r.rows)?r.rows:[],i=Array.isArray(r.columns)?r.columns:[];n.length&&n.length!==e&&a(`warn`,`Rubric rows list does not match row count.`),i.length&&i.length!==t&&a(`warn`,`Rubric columns list does not match column count.`)}if(n===`knowledge_check`){let e=Array.isArray(r.questions)?r.questions:[];e.length?e.forEach((e,t)=>{let n=ae(e?.type||e?.kind);String(e?.prompt||``).trim()||a(`warn`,`Knowledge check question #${t+1} prompt is empty.`),n===`multiple_choice`&&(Array.isArray(e?.options)?e.options:[]).filter(e=>String(e||``).trim()).length<2&&a(`warn`,`Knowledge check question #${t+1} should have at least 2 options.`)}):(String(r.prompt||``).trim()||a(`warn`,`Knowledge check prompt is empty.`),(Array.isArray(r.options)?r.options:[]).length<2&&a(`warn`,`Knowledge check should have at least 2 options.`))}if(n===`worksheet_form`){let e=ie(r);e.length||a(`warn`,`Worksheet has no blocks yet.`),e.filter(e=>e.kind===`field`).length||a(`warn`,`Worksheet should include at least one input field.`)}if(n===`fillable_chart`){let e=re(r);e.rows.length||a(`warn`,`Fillable chart needs at least one row.`),e.columns.length||a(`warn`,`Fillable chart needs at least one column.`);let t=Array.isArray(r.rows)?r.rows:[],n=Array.isArray(r.columns)?r.columns:[];t.length&&t.length!==e.rowCount&&a(`warn`,`Fillable chart rows list does not match row count.`),n.length&&n.length!==e.colCount&&a(`warn`,`Fillable chart columns list does not match column count.`);let i=Array.isArray(r.cells)?r.cells:[],o=i.length>0&&i.length!==e.rowCount,s=i.some(t=>Array.isArray(t)&&t.length!==e.colCount);(o||s)&&a(`warn`,`Fillable chart cells grid does not match row/column counts.`),e.cells.flat().filter(e=>e.editable).length||a(`warn`,`Fillable chart has no editable cells for student responses.`)}if(n===`tab_group`){let e=Array.isArray(r.tabs)?r.tabs:[];e.length||a(`warn`,`Tab group has no tabs configured.`),e.forEach((e,t)=>{let n=Array.isArray(e?.activityIds)?e.activityIds.filter(Boolean):[],r=Array.isArray(e?.activities)?e.activities.filter(Boolean):[];!n.length&&!r.length&&a(`warn`,`Tab #${t+1} has no referenced or inline activities.`)})}if(n===`card_list`){let e=Array.isArray(r.cards)?r.cards:[];e.length||a(`warn`,`Card list has no cards configured.`),e.forEach((e,t)=>{let n=!!String(e?.targetActivityId||``).trim(),r=!!(e?.activity&&typeof e.activity==`object`),i=Array.isArray(e?.activities)&&e.activities.some(e=>e&&typeof e==`object`);!n&&!r&&!i&&a(`warn`,`Card #${t+1} has no target activity.`)})}n===`hotspot_image`&&(String(r.imageUrl||r.url||``).trim()||a(`warn`,`Hotspot image URL is empty.`),String(r.imageUrl||r.url||``).trim()&&!i(r.imageUrl||r.url)&&a(`warn`,`Hotspot image URL format looks invalid.`),(Array.isArray(r.hotspots)?r.hotspots:[]).length===0&&a(`warn`,`No hotspots defined yet.`));let o=E(r).reduce((e,t)=>e+xe(t),0);o>0&&a(`warn`,`${o} heading tag${o===1?``:`s`} appear empty.`);let s=Se(r.blockTextColor),c=Se(r.bodyContainerBg||r.blockContainerBg||r.containerBg);if(s&&c){let e=Ce(s,c);e>0&&e<3?a(`error`,`Text contrast is very low (${e.toFixed(2)}:1).`):e>0&&e<4.5&&a(`warn`,`Text contrast may be hard to read (${e.toFixed(2)}:1).`)}return t.filter(e=>e&&e.message)}function Ee(e){let t=Array.isArray(e)?e:[],n=t.map(e=>String(e?.id||``).trim()),r=new Set(n.filter(Boolean)),i=new Set(n.filter((e,t)=>e&&n.indexOf(e)!==t)),a=new Set;return t.forEach((e,t)=>{we(e,t).forEach(e=>a.add(e))}),t.map((e,t)=>{let n=String(e?.id||``).trim(),o=e?.type||``,s=Te(e),c=e?.data&&typeof e.data==`object`?e.data:{},l=e?.layout?.breakpoints?.mobile,u=l&&typeof l==`object`&&Object.keys(l).some(e=>l[e]!==``&&l[e]!=null);if(n?i.has(n)&&s.push({level:`error`,message:`Activity ID is duplicated. Duplicate IDs break references and preview selection.`}):s.push({level:`warn`,message:`Activity ID is missing.`}),!u){let t=Math.max(1,Number.parseInt(e?.layout?.colSpan,10)||1),n=Math.max(1,Number.parseInt(e?.layout?.col,10)||1),r=Math.max(0,Number.parseInt(e?.layout?.x,10)||0),i=Math.max(1,Number.parseInt(e?.layout?.w,10)||t);(t>1||n>1||r>0||i>1)&&s.push({level:`warn`,message:`No mobile override for this multi-column placement. It may overflow or feel cramped on small screens.`})}let d=new Set;return E(c).forEach(e=>{be(e).forEach(e=>{a.has(e)||d.add(e)})}),d.size>0&&s.push({level:`warn`,message:`Internal anchor target${d.size===1?``:`s`} missing: ${Array.from(d).join(`, `)}.`}),o===`tab_group`&&(Array.isArray(c.tabs)?c.tabs:[]).forEach((e,t)=>{let n=(Array.isArray(e?.activityIds)?e.activityIds:[]).map(e=>String(e||``).trim()).filter(e=>e&&!r.has(e));n.length>0&&s.push({level:`warn`,message:`Tab #${t+1} references missing activities: ${n.join(`, `)}.`})}),o===`card_list`&&(Array.isArray(c.cards)?c.cards:[]).forEach((e,t)=>{let n=String(e?.targetActivityId||``).trim();n&&!r.has(n)&&s.push({level:`warn`,message:`Card #${t+1} references missing activity: ${n}.`})}),{index:t,id:n,type:o,issues:s.filter(e=>e&&e.message)}})}function De(e){return(Array.isArray(e)?e:[]).reduce((e,t)=>((Array.isArray(t?.issues)?t.issues:[]).forEach(t=>{t?.level===`error`?e.error+=1:e.warn+=1}),e),{error:0,warn:0})}const Oe=`simple`,ke=[12,12],Ae=[12,12],je=[`tablet`,`mobile`];var Me=[`sm`,`md`,`lg`],Ne=[`card`,`flat`],Pe=[`xs`,`sm`,`md`,`lg`,`xl`];function O(e,t){let n=Number.parseInt(e,10);return Number.isFinite(n)?n:t}function k(e,t=1){let n=Number.parseInt(e,10);return Number.isFinite(n)?Math.max(1,n):t}function Fe(e,t=0){let n=Number.parseInt(e,10);return Number.isFinite(n)?Math.max(0,n):t}function Ie(e,t,n,r){let i=O(e,r);return Math.max(t,Math.min(n,i))}function Le(e){let t=Number.parseInt(e,10);return Number.isFinite(t)}function Re(e,t){return`${e}:${t}`}function ze(e,t=[12,12]){let n=Array.isArray(e)?e:t;return[Ie(n[0],0,200,t[0]),Ie(n[1],0,200,t[1])]}function Be(e){return String(e||``).trim().toLowerCase()===`canvas`?`canvas`:`simple`}function Ve(e){let t=String(e||``).trim().toLowerCase();return Ne.includes(t)?t:`card`}function He(e){let t=String(e||``).trim().toLowerCase();return Me.includes(t)?t:`md`}function Ue(e){let t=String(e||``).trim().toLowerCase();return Pe.includes(t)?t:`md`}function We(e,t){return!e||typeof e!=`object`?!1:t.some(t=>Object.prototype.hasOwnProperty.call(e,t)&&e[t]!==``&&e[t]!==null)}function Ge(e){let t=e&&typeof e==`object`?{...e}:{};return t.border=t.border!==!1,t.variant=Ve(t.variant),t.padding=He(t.padding),t.titleVariant=Ue(t.titleVariant),t}function Ke(e){let t=e&&typeof e==`object`?{...e}:{};return t.collapsible=t.collapsible===!0,t.collapsedByDefault=t.collapsible?t.collapsedByDefault===!0:!1,t}function A(e){let t=O(e,1);return Math.max(1,Math.min(4,t))}function j(e,t=1){let n=A(t),r=O(e,1);return Math.max(1,Math.min(n,r))}function M(e){return k(e,1)}function N(e,t=1,n=1){let r=A(t),i=j(n,r),a=Math.max(1,r-i+1),o=k(e,1);return Math.min(o,a)}function P(e,t=1){return j(e,t)}function F(e,t=1,n=1){let r=A(t),i=P(n,r),a=Math.max(0,r-i),o=Fe(e,0);return Math.min(o,a)}function I(e){return Fe(e,0)}function L(e){return k(e,4)}function R(e){let t=e&&typeof e==`object`?{...e}:{};return t.mode=Be(t.mode),t.maxColumns=A(t.maxColumns),t.rowHeight=Ie(t.rowHeight,8,200,24),t.margin=ze(t.margin,ke),t.containerPadding=ze(t.containerPadding,Ae),t.simpleMatchTallestRow=t.simpleMatchTallestRow===!0,t}function qe(e,t,n,r,i){if(t<1||n<1||n+r-1>i)return!1;for(let i=n;i<n+r;i+=1)if(e.has(Re(t,i)))return!1;return!0}function Je(e,t,n,r){for(let i=n;i<n+r;i+=1)e.add(Re(t,i))}function Ye(e,t,n,r,i){let a=Math.max(1,i-r+1),o=Math.max(1,t),s=Math.max(1,n);for(s>a&&(o+=1,s=1);;){if(s>a){o+=1,s=1;continue}if(qe(e,o,s,r,i))return{row:o,col:s};s+=1,s>i&&(o+=1,s=1)}}function Xe(e,t){let n=e&&typeof e==`object`?{...e}:{};return delete n.breakpoints,delete n.hidden,n.colSpan=j(n.colSpan,t),Le(n.row)?n.row=k(n.row,1):delete n.row,Le(n.col)?n.col=k(n.col,1):delete n.col,n.w=P(n.w??n.colSpan,t),n.x=F(n.x??(n.col||1)-1,t,n.w),n.y=I(n.y??(n.row||1)-1),n.h=L(n.h),n}function Ze(e,t){let n=e&&typeof e==`object`?{...e}:{};return delete n.breakpoints,delete n.hidden,n.w=P(n.w??n.colSpan,t),n.h=L(n.h),n.x=F(n.x??(n.col||1)-1,t,n.w),n.y=I(n.y??(n.row||1)-1),n.colSpan=j(n.colSpan??n.w,t),n.col=N(n.col||n.x+1,t,n.colSpan),n.row=M(n.row||n.y+1),n}function Qe(e,t,n,r){let i=e&&typeof e==`object`?{...e}:null;if(!i)return null;let a=i.hidden===!0;if(n===`canvas`){if(!We(i,[`x`,`y`,`w`,`h`,`colSpan`,`col`,`row`])&&!a)return null;let e=Ze({...r&&typeof r==`object`?r:{},...i},t);return a&&(e.hidden=!0),e}if(!We(i,[`colSpan`,`row`,`col`])&&!a)return null;let o=Xe({...r&&typeof r==`object`?r:{},...i},t);return a&&(o.hidden=!0),o}function $e(e,t,n,r){let i=e&&typeof e==`object`?e:null;if(!i)return null;let a={};return je.forEach(e=>{let o=Qe(i[e],t,n,r);o&&(a[e]=o)}),Object.keys(a).length>0?a:null}function et(e,t,{maxColumns:n=1,mode:r=Oe}={}){let i=String(t||``).trim().toLowerCase();if(!je.includes(i))return null;let a=z(e,0,n,r)?.layout?.breakpoints?.[i];return a&&typeof a==`object`?{...a}:null}function tt(e,t,{maxColumns:n=1,mode:r=Oe}={}){let i=z(e,0,n,r),a=String(t||`desktop`).trim().toLowerCase(),o=i?.layout&&typeof i.layout==`object`?{...i.layout}:{},s=o.breakpoints&&typeof o.breakpoints==`object`?o.breakpoints:{};if(delete o.breakpoints,!je.includes(a))return{...o,hidden:!1,hasOverride:!1};let c=s[a];return!c||typeof c!=`object`?{...o,hidden:!1,hasOverride:!1}:{...o,...c,hidden:c.hidden===!0,hasOverride:!0}}function z(e,t,n=1,r=Oe){let i=e&&typeof e==`object`?{...e}:{};i.type=i.type||`content_block`,i.id=i.id||`activity-${t+1}`,i.data=i.data&&typeof i.data==`object`?i.data:{},i.style=Ge(i.style),i.behavior=Ke(i.behavior);let a=i.layout&&typeof i.layout==`object`?{...i.layout}:{},o=a.breakpoints;r===`canvas`?i.layout=Ze(a,n):i.layout=Xe(a,n);let s=$e(o,n,r,i.layout);return s&&(i.layout.breakpoints=s),i}function nt(e){if(!(e instanceof Map)||e.size===0)return e;let t=Array.from(e.values()).map(e=>M(e?.row||1)).sort((e,t)=>e-t).filter((e,t,n)=>t===0||e!==n[t-1]);if(t.length<=1)return e;let n=new Map(t.map((e,t)=>[e,t+1])),r=new Map;return e.forEach((e,t)=>{let i=M(e?.row||1);r.set(t,{...e,row:n.get(i)||i})}),r}function rt(e,t=1,{fixedPlacement:n}={}){let r=A(t),i=Array.isArray(e)?e.map((e,t)=>z(e,t,r,`simple`)):[];if(i.length===0)return[];let a=i.map((e,t)=>{let n=j(e?.layout?.colSpan,r);return{index:t,colSpan:n,anchorRow:M(e?.layout?.row||1),anchorCol:N(e?.layout?.col||1,r,n)}}),o=Number.isInteger(n?.index)?n.index:null,s=new Set,c=new Map;if(o!==null&&o>=0&&o<a.length){let e=a[o],t=Ye(s,M(n?.row||e.anchorRow),N(n?.col||e.anchorCol,r,e.colSpan),e.colSpan,r);c.set(e.index,{row:t.row,col:t.col,colSpan:e.colSpan}),Je(s,t.row,t.col,e.colSpan)}a.filter(e=>e.index!==o).sort((e,t)=>e.anchorRow===t.anchorRow?e.anchorCol===t.anchorCol?e.index-t.index:e.anchorCol-t.anchorCol:e.anchorRow-t.anchorRow).forEach(e=>{let t=Ye(s,e.anchorRow,e.anchorCol,e.colSpan,r);c.set(e.index,{row:t.row,col:t.col,colSpan:e.colSpan}),Je(s,t.row,t.col,e.colSpan)});let l=nt(c);return i.map((e,t)=>{let n=l.get(t)||{row:M(e?.layout?.row||1),col:N(e?.layout?.col||1,r,e?.layout?.colSpan||1),colSpan:j(e?.layout?.colSpan,r)};return{...e,layout:{...e.layout||{},colSpan:n.colSpan,row:n.row,col:n.col,w:P(e?.layout?.w??n.colSpan,r),h:L(e?.layout?.h),x:F(e?.layout?.x??n.col-1,r,e?.layout?.w??n.colSpan),y:I(e?.layout?.y??n.row-1)}}})}function it(e,t){return!(e.x+e.w<=t.x||t.x+t.w<=e.x||e.y+e.h<=t.y||t.y+t.h<=e.y)}function at(e,t){return!t.some(t=>it(e,t))}function ot(e,t,n,{maxColumns:r=1}={}){let i=A(r),a={x:O(n?.x,0),y:O(n?.y,0),w:O(n?.w??n?.colSpan,1),h:O(n?.h,1)};if(a.w<1||a.h<1||a.x<0||a.y<0||a.x+a.w>i)return{valid:!1,reason:`bounds`,rect:a};let o=(Array.isArray(e)?e.map((e,t)=>({activity:e,index:t})).filter(({index:e})=>e!==t).map(({activity:e,index:t})=>{let n=z(e,t,i,`canvas`);return{index:t,x:O(n?.layout?.x,0),y:O(n?.layout?.y,0),w:O(n?.layout?.w,1),h:O(n?.layout?.h,1)}}):[]).find(e=>it(a,e));return o?{valid:!1,reason:`collision`,rect:a,collisionIndex:o.index}:{valid:!0,reason:null,rect:a}}function st(e,t,n,r){let i=e+t-1,a=n+r-1;return!(i<n||a<e)}function ct(e,t,n,{maxColumns:r=1}={}){let i=A(r),a=O(n?.row,1),o=O(n?.col,1),s=O(n?.colSpan,1),c={row:M(a),colSpan:j(s,i)};if(c.col=N(o,i,1),a<1||o<1||s<1)return{valid:!1,reason:`bounds`,layout:c};let l=(Array.isArray(e)?e.map((e,t)=>({activity:e,index:t})).filter(({index:e})=>e!==t).map(({activity:e,index:t})=>{let n=z(e,t,i,`simple`);return{index:t,row:M(n?.layout?.row||1),col:N(n?.layout?.col||1,i,n?.layout?.colSpan||1),colSpan:j(n?.layout?.colSpan,i)}}):[]).filter(e=>e.row===c.row),u=new Set;l.forEach(e=>{let t=e.col+e.colSpan-1;for(let n=e.col;n<=t;n+=1)u.add(n)});let d=0;for(let e=c.col;e<=i&&!u.has(e);e+=1)d+=1;if(d<1){let e=l.find(e=>st(c.col,1,e.col,e.colSpan));return{valid:!1,reason:`collision`,layout:{...c,colSpan:1},collisionIndex:e?.index}}let f=Math.max(1,Math.min(c.colSpan,d));return{valid:!0,reason:f<c.colSpan?`autofit`:null,layout:{...c,colSpan:f},fitted:f<c.colSpan}}function lt(e,t=1){let n=A(t),r=Array.isArray(e)?e.map((e,t)=>z(e,t,n,`canvas`)):[];if(!r.length)return[];let i=r.map((e,t)=>({index:t,x:F(e.layout?.x,n,e.layout?.w),y:I(e.layout?.y),w:P(e.layout?.w,n),h:L(e.layout?.h)})).sort((e,t)=>e.y===t.y?e.x===t.x?e.index-t.index:e.x-t.x:e.y-t.y),a=[];i.forEach(e=>{let t=e.y,r=e.x,i={...e};for(;;){if(i.x=F(r,n,i.w),i.y=I(t),at(i,a)){a.push({...i});break}t+=1}});let o=new Map(a.map(e=>[e.index,e]));return r.map((e,t)=>{let r=o.get(t)||{x:0,y:0,w:1,h:4},i=j(e?.layout?.colSpan??r.w,n);return{...e,layout:{...e.layout||{},x:r.x,y:r.y,w:r.w,h:r.h,colSpan:i,col:N(e?.layout?.col||r.x+1,n,i),row:M(e?.layout?.row||r.y+1)}}})}function B(e,{maxColumns:t=1,mode:n=Oe}={}){let r=A(t),i=Be(n);return Array.isArray(e)?i===`canvas`?lt(e,r):rt(e,r):[]}function ut(e){let t=R(e?.composerLayout);return{composerLayout:t,activities:B(e?.activities,{maxColumns:t.maxColumns,mode:t.mode})}}function dt(e,t=1,{includeTrailingRow:n=!0,trailingRows:r=0}={}){let i=A(t),a=B(e,{maxColumns:i,mode:`simple`}).map((e,t)=>({index:t,row:M(e?.layout?.row||1),col:N(e?.layout?.col||1,i,e?.layout?.colSpan||1),colSpan:j(e?.layout?.colSpan,i)})),o=new Set;a.forEach(e=>{Je(o,e.row,e.col,e.colSpan)});let s=a.reduce((e,t)=>Math.max(e,t.row),1),c=n&&Number.isInteger(r)?Math.max(0,r):0,l=a.length>0?s:1,u=Math.max(1,l+c),d=[];for(let e=1;e<=u;e+=1)for(let t=1;t<=i;t+=1)o.has(Re(e,t))||d.push({key:`slot-${e}-${t}`,row:e,col:t});return{maxColumns:i,rowCount:u,placements:a,emptySlots:d}}function ft(e,t,n,r,{maxColumns:i=1}={}){let a=A(i),o=B(e,{maxColumns:a,mode:`simple`});if(!Number.isInteger(t)||t<0||t>=o.length)return{activities:o,toIndex:t,changed:!1};let s=o[t],c=j(s?.layout?.colSpan,a),l=rt(o,a,{fixedPlacement:{index:t,row:M(n||s?.layout?.row||1),col:N(r||s?.layout?.col||1,a,c)}});return{activities:l,toIndex:t,changed:l.some((e,t)=>{let n=o[t]?.layout||{},r=e?.layout||{};return n.row!==r.row||n.col!==r.col||n.colSpan!==r.colSpan})}}const pt=[`auto`,`image`,`video`,`embed`],mt=[`activities`];function ht(e,t=`tab`){return String(e||``).trim().toLowerCase().replace(/[^a-z0-9_-]+/g,`-`).replace(/^-+|-+$/g,``)||t}function V(e){return e==null?``:String(e)}function gt(e){let t=String(e||``).trim().toLowerCase();return pt.includes(t)?t:`auto`}function _t(e){let t=e&&typeof e==`object`?e:{},n=t.mediaUrl??t.image??``;return{title:V(t.title),subtitle:V(t.subtitle),progressLabel:V(t.progressLabel),mediaUrl:V(n),mediaType:gt(t.mediaType)}}function vt(e){let t=_t(e),n=t.title.trim(),r=t.subtitle.trim(),i=t.progressLabel.trim(),a=t.mediaUrl.trim(),o=gt(t.mediaType),s={};return n&&(s.title=n),r&&(s.subtitle=r),i&&(s.progressLabel=i),a&&(s.mediaUrl=a),o!==`auto`&&(s.mediaType=o),Object.keys(s).length?s:null}var yt=/\.(mp4|webm|ogg|ogv|m4v|mov|m3u8)([?#].*)?$/i,bt=/(youtube\.com|youtu\.be|vimeo\.com|loom\.com|wistia\.)/i,xt=/\/embed\/|\/player\//i;function St(e){let t=_t(e),n=t.mediaUrl.trim();if(!n)return`none`;let r=gt(t.mediaType);if(r===`image`||r===`video`||r===`embed`)return r;let i=n.toLowerCase();return i.startsWith(`data:video/`)||yt.test(i)?`video`:xt.test(i)||bt.test(i)?`embed`:`image`}function H(e){let t=e&&typeof e==`object`?e:{};return{title:V(t.title||t.label),url:V(t.url||t.href),description:V(t.description||t.subtitle)}}function Ct(e){return Array.isArray(e)?e.filter(e=>e&&typeof e==`object`).map(e=>{try{return JSON.parse(JSON.stringify(e))}catch{return{...e}}}):[]}function wt(e,t=0){let n=e&&typeof e==`object`?e:{},r=V(n.id||n.key||n.slug||`tab-${t+1}`),i=ht(r,`tab-${t+1}`),a=V(n.label||n.title||r||`Tab ${t+1}`),o=(Array.isArray(n.activityIds)?n.activityIds:[]).map(e=>V(e).trim()).filter(Boolean),s=(Array.isArray(n.links)?n.links:Array.isArray(n.additionalLinks)?n.additionalLinks:[]).map(e=>H(e));return{id:i,label:a,activityIds:o,...Object.prototype.hasOwnProperty.call(n,`activities`)?{activities:Ct(n.activities)}:{},links:s}}function Tt(e){let t=new Set;return e.map((e,n)=>{let r=wt(e,n),i=r.id,a=2;for(;t.has(i);)i=`${r.id}-${a}`,a+=1;return t.add(i),{...r,id:i}})}function Et(e){let t=V(e.activitiesTabLabel||e.activitiesLabel||`Activities`),n=V(e.additionalTabLabel||e.additionalLabel||`Additional Learning`),r=Array.isArray(e.additionalLinks)?e.additionalLinks.map(e=>H(e)):[];return[{id:`activities`,label:t,activityIds:[],links:[]},{id:`additional`,label:n,activityIds:[],links:r}]}function Dt(e,t){let n=Tt(e),r=new Map(n.map(e=>[e.id,e])),i=Et(t),a=new Map(i.map(e=>[e.id,e]));mt.forEach(e=>{r.has(e)||r.set(e,wt(a.get(e)))});let o=n.map(e=>r.get(e.id)).filter(Boolean);return mt.forEach(e=>{o.some(t=>t.id===e)||o.push(r.get(e))}),o.map(e=>{let t=a.get(e.id);return{...e,label:V(e.label||t?.label||(e.id===`additional`?`Additional Learning`:`Activities`)),activityIds:Array.from(new Set((Array.isArray(e.activityIds)?e.activityIds:[]).map(e=>V(e).trim()).filter(Boolean))),...Object.prototype.hasOwnProperty.call(e,`activities`)?{activities:Ct(e.activities)}:{},links:(Array.isArray(e.links)?e.links:[]).map(e=>H(e))}})}function Ot(e){let t=e&&typeof e==`object`?e:{};return Dt(Array.isArray(t.tabs)&&t.tabs.length>0?t.tabs:Et(t),t)}function U(e){let t=Ot(e&&typeof e==`object`?e:{}),n=t.find(e=>e.id===`activities`),r=t.find(e=>e.id===`additional`),i=Array.isArray(r?.links)?r.links.map(e=>H(e)):[];return{activitiesTabLabel:V(n?.label||`Activities`),additionalTabLabel:V(r?.label||`Additional Learning`),additionalLinks:i,tabs:t}}function kt(e){let t=U(e),n=Dt(Array.isArray(t.tabs)?t.tabs:[],t).map((e,t)=>{let n=V(e?.label||e?.id||`Tab ${t+1}`).trim()||`Tab ${t+1}`,r=ht(e?.id||`tab-${t+1}`,`tab-${t+1}`),i=Array.from(new Set((Array.isArray(e?.activityIds)?e.activityIds:[]).map(e=>V(e).trim()).filter(Boolean))),a=(Array.isArray(e?.links)?e.links:[]).map(e=>H(e)).map(e=>({title:e.title.trim(),url:e.url.trim(),description:e.description.trim()})).filter(e=>e.title||e.url||e.description).map(e=>({title:e.title||e.url||`Resource`,url:e.url,description:e.description}));return{id:r,label:n,activityIds:i,...Object.prototype.hasOwnProperty.call(e||{},`activities`)?{activities:Ct(e?.activities)}:{},links:a}}).filter(e=>e.label||e.activityIds.length>0||e.links.length>0||Array.isArray(e.activities)&&e.activities.length>0),r=n.find(e=>e.id===`activities`)||{id:`activities`,label:`Activities`,activityIds:[],links:[]},i=n.find(e=>e.id===`additional`)||{id:`additional`,label:`Additional Learning`,activityIds:[],links:[]},a=V(r.label).trim()||`Activities`,o=V(i.label).trim()||`Additional Learning`,s=(Array.isArray(i.links)?i.links:[]).map(e=>H(e)).map(e=>({title:e.title.trim(),url:e.url.trim(),description:e.description.trim()})).filter(e=>e.title||e.url||e.description).map(e=>({title:e.title||e.url||`Resource`,url:e.url,description:e.description})),c={},l=U(null).tabs;return JSON.stringify(n)!==JSON.stringify(l)&&(c.tabs=n),a!==`Activities`&&(c.activitiesTabLabel=a),o!==`Additional Learning`&&(c.additionalTabLabel=o),s.length>0&&(c.additionalLinks=s),c.tabs&&(c.activitiesTabLabel=a,c.additionalTabLabel=o,c.additionalLinks=s),Object.keys(c).length?c:null}function At(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function jt(e){return String(e||``).replace(/([a-z0-9])([A-Z])/g,`$1 $2`).replace(/[_-]+/g,` `).replace(/\s+/g,` `).trim().replace(/^\w/,e=>e.toUpperCase())}function Mt(e){let t=[];return String(e||``).replace(/([^[.\]]+)|\[(\d+)\]/g,(e,n,r)=>(n?t.push(n):t.push(Number.parseInt(r,10)),``)),t}function Nt(e,t){return Mt(t).reduce((e,t)=>{if(e!=null)return e[t]},e)}function Pt(e,t,n){let r=Mt(t);if(!r.length)return e;let i=Array.isArray(e)?[...e]:{...e&&typeof e==`object`?e:{}},a=i;return r.forEach((e,t)=>{if(t===r.length-1){a[e]=n;return}let i=r[t+1],o=a[e],s;s=Array.isArray(o)?[...o]:o&&typeof o==`object`?{...o}:typeof i==`number`?[]:{},a[e]=s,a=s}),i}function Ft(e){return e==null?``:typeof e==`string`?e:typeof e==`number`||typeof e==`boolean`?String(e):``}function It(e){let t=String(e||``).trim();return t?/(title|label|text|body|subtitle|description|caption|heading|summary|prompt|author|placeholder|progress|kicker|eyebrow|quote|name|url|href|alt|button|cta)/i.test(t):!1}function Lt(e,t=[],n=[]){if(Array.isArray(e))return e.forEach((e,r)=>Lt(e,[...t,r],n)),n;if(At(e))return Object.entries(e).forEach(([e,r])=>Lt(r,[...t,e],n)),n;let r=t[t.length-1];if(!It(r)||!(typeof e==`string`||e==null))return n;let i=t.map(e=>typeof e==`number`?`${e+1}`:jt(e)).join(` / `),a=t.map((e,t)=>typeof e==`number`?`[${e}]`:t===0?e:`.${e}`).join(``);return n.push({path:a,label:i,value:typeof e==`string`?e:``}),n}const Rt=[{value:`course.name`,label:`Course Name`},{value:`course.theme`,label:`Course Theme`},{value:`module.title`,label:`Module Title`},{value:`module.id`,label:`Module ID`},{value:`module.template`,label:`Module Template`},{value:`module.theme`,label:`Module Theme`},{value:`module.blockCount`,label:`Module Block Count`},{value:`date.today`,label:`Today (YYYY-MM-DD)`},{value:`date.year`,label:`Current Year`}];function zt(e){return`{{${String(e||``).trim()}}}`}function Bt(e,{courseSettings:t={},activities:n=[],activity:r=null}={}){let i=new Date;return{course:{name:String(t?.courseName||t?.__courseName||``).trim()||`Course`,theme:String(t?.themeDefault||t?.theme||``).trim()||``},module:{id:String(e?.id||``).trim()||``,title:String(e?.title||``).trim()||``,template:String(e?.template||``).trim()||``,theme:String(e?.theme||``).trim()||``,blockCount:Array.isArray(n)?n.length:0},activity:{id:String(r?.id||``).trim()||``,type:String(r?.type||``).trim()||``},date:{today:i.toISOString().slice(0,10),year:String(i.getFullYear())}}}function Vt(e,t){return Ft(Nt(t,e))}function Ht(e,t){let n=String(e??``);return n.includes(`{{`)?n.replace(/\{\{\s*([a-zA-Z0-9_.]+)\s*\}\}/g,(e,n)=>Vt(n,t)):n}function W(e,t){return typeof e==`string`?Ht(e,t):Array.isArray(e)?e.map(e=>W(e,t)):At(e)?Object.fromEntries(Object.entries(e).map(([e,n])=>[e,W(n,t)])):e}function Ut(e,t){return!e||typeof e!=`object`?e:{...e,data:W(e.data||{},t),style:W(e.style||{},t),behavior:W(e.behavior||{},t)}}function Wt(e){return Lt(e?.data&&typeof e.data==`object`?e.data:{})}function Gt(e,t,n){let r=String(t||``).trim(),i=String(n||``).trim();return!r||!i||!e||typeof e!=`object`?e:{...e,data:Pt(e.data&&typeof e.data==`object`?e.data:{},r,zt(i))}}const Kt=[{value:`dark_cards`,label:`Dark Cards`},{value:`finlit_clean`,label:`FinLit Clean`},{value:`coursebook_light`,label:`Coursebook Light`},{value:`toolkit_clean`,label:`Toolkit Clean`},{value:`saas_clean`,label:`SaaS Clean`},{value:`lms_pastel`,label:`LMS Pastel`},{value:`crypto_neon`,label:`Crypto Neon`}],qt=Kt.map(e=>e.value),Jt=[{value:`foundation`,label:`Foundation`},{value:`premium_dribbble`,label:`Premium (Dribbble-grade)`}].map(e=>e.value);function Yt(e,t=`dark_cards`){let n=String(e||``).trim().toLowerCase();return n&&qt.includes(n)?n:t}function Xt(e,t=`premium_dribbble`){let n=String(e||``).trim().toLowerCase();return n&&Jt.includes(n)?n:t}function G(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Zt(e){let t=String(e||``).trim();return t?/^(https?:|mailto:|tel:)/i.test(t)||/^(\/|\.\/|\.\.\/|#)/.test(t)?t:/^materials\//i.test(t)?`/${t}`:``:``}var Qt={Arial:`Arial, Helvetica, sans-serif`,Helvetica:`Helvetica, Arial, sans-serif`,Verdana:`Verdana, Geneva, sans-serif`,Tahoma:`Tahoma, Geneva, sans-serif`,"Trebuchet MS":`Trebuchet MS, Helvetica, sans-serif`,"Segoe UI":`Segoe UI, Tahoma, sans-serif`,Georgia:`Georgia, serif`,Garamond:`Garamond, serif`,"Palatino Linotype":`Palatino Linotype, Book Antiqua, Palatino, serif`,"Times New Roman":`Times New Roman, Times, serif`,"Courier New":`Courier New, Courier, monospace`,"Lucida Console":`Lucida Console, Monaco, monospace`,Impact:`Impact, Haettenschweiler, Arial Narrow Bold, sans-serif`,"Comic Sans MS":`Comic Sans MS, Comic Sans, cursive`,Inter:`Inter, sans-serif`,Roboto:`Roboto, sans-serif`,"Open Sans":`Open Sans, sans-serif`,Lato:`Lato, sans-serif`,Montserrat:`Montserrat, sans-serif`,Poppins:`Poppins, sans-serif`,Raleway:`Raleway, sans-serif`,Nunito:`Nunito, sans-serif`,"Playfair Display":`Playfair Display, serif`,Merriweather:`Merriweather, serif`,Oswald:`Oswald, sans-serif`,"Bebas Neue":`Bebas Neue, sans-serif`},$t={default:null,slate:{textColor:`#dbe3ee`,containerBg:`rgba(15, 23, 42, 0.82)`,borderColor:`rgba(71, 85, 105, 0.7)`,accentColor:`#7dd3fc`},ocean:{textColor:`#dbeafe`,containerBg:`rgba(30, 58, 138, 0.45)`,borderColor:`rgba(96, 165, 250, 0.7)`,accentColor:`#38bdf8`},forest:{textColor:`#dcfce7`,containerBg:`rgba(20, 83, 45, 0.5)`,borderColor:`rgba(74, 222, 128, 0.6)`,accentColor:`#4ade80`},sunset:{textColor:`#ffedd5`,containerBg:`rgba(154, 52, 18, 0.45)`,borderColor:`rgba(251, 146, 60, 0.65)`,accentColor:`#fb923c`},mono:{textColor:`#f8fafc`,containerBg:`rgba(17, 24, 39, 0.82)`,borderColor:`rgba(148, 163, 184, 0.6)`,accentColor:`#cbd5e1`}},en={tablet:`(max-width: 1024px)`,mobile:`(max-width: 640px)`};function tn(e){let t=String(e||``).trim();return/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.test(t)?t:``}function nn(e){let t=String(e||``).trim().toLowerCase();return Object.prototype.hasOwnProperty.call($t,t)?t:`default`}function rn(e){return Qt[String(e||``).trim()]||``}function an(e={}){let t=nn(e.blockTheme),n=$t[t];return{themeKey:t,fontFamily:rn(e.blockFontFamily),textColor:tn(e.blockTextColor)||n?.textColor||``,containerBg:tn(e.blockContainerBg||e.containerBg)||n?.containerBg||``,borderColor:n?.borderColor||``,accentColor:n?.accentColor||``}}function on(){return`
    (function() {
  ...
  `}var sn=[`deck`,`finlit`,`coursebook`,`toolkit_dashboard`],cn=qt;function ln(e,t=`deck`){let n=String(e||``).trim().toLowerCase();return n&&sn.includes(n)?n:t}function un(e,t=`dark_cards`){return Yt(e,t)}function dn(e,t=`premium_dribbble`){return Xt(e,t)}function fn(e={}){let t=e&&typeof e==`object`?e:{},n=String(t.variant||``).trim().toLowerCase(),r=String(t.padding||``).trim().toLowerCase(),i=String(t.titleVariant||``).trim().toLowerCase();return{border:t.border!==!1,variant:n===`flat`?`flat`:`card`,padding:r===`sm`||r===`lg`?r:`md`,titleVariant:[`xs`,`sm`,`md`,`lg`,`xl`].includes(i)?i:`md`}}function pn(e={}){let t=e&&typeof e==`object`?e:{},n=t.collapsible===!0;return{collapsible:n,collapsedByDefault:n?t.collapsedByDefault===!0:!1}}function K(e){return String(e||``).replace(/<[^>]+>/g,` `).replace(/&nbsp;/gi,` `).replace(/&amp;/gi,`&`).replace(/&lt;/gi,`<`).replace(/&gt;/gi,`>`).replace(/&#39;/gi,`'`).replace(/&quot;/gi,`"`).replace(/\s+/g,` `).trim()}function q(e,t=`item`){return String(e||``).trim().toLowerCase().replace(/<[^>]*>/g,``).replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||t}function mn(e=``,t=``){let n=[],r=/<h([1-4])[^>]*>([\s\S]*?)<\/h\1>/gi,i=r.exec(e);for(;i;){let a=K(i[2]);a&&n.push({level:Number.parseInt(i[1],10)||3,text:a,anchor:t}),i=r.exec(e)}return n}function hn(){return`
    (function() {
  ...
  `}function gn(e,{courseSettings:t={}}={}){let{composerLayout:n,activities:r}=ut(e),i=Bt(e,{courseSettings:t,activities:r}),a=r.map(e=>Ut(e,{...i,activity:{id:String(e?.id||``).trim(),type:String(e?.type||``).trim()}})),o=new Map;a.forEach(e=>{let t=String(e?.id||``).trim();t&&o.set(t,e)});let s=ln(e?.template,ln(t?.templateDefault,`deck`)),c=un(e?.theme,un(t?.themeDefault,`dark_cards`)),l=dn(e?.composerVisualQuality,dn(t?.composerVisualQuality,`premium_dribbble`)),u=`cf-theme-${c}`,d=`cf-visual-${l}`,f=(e,t=`inline`)=>B((Array.isArray(e)?e:[]).map((e,n)=>({id:e?.id||`${t}-${n+1}-${Math.random().toString(36).slice(2,8)}`,type:e?.type||`content_block`,data:e?.data||{},layout:e?.layout||{colSpan:1},style:e?.style||{},behavior:e?.behavior||{}})),{maxColumns:n.maxColumns,mode:n.mode}).map(e=>Ut(e,{...i,activity:{id:String(e?.id||``).trim(),type:String(e?.type||``).trim()}})),p=(e,t,{withLayout:r=!0,trail:i=[]}={})=>{let a=String(e?.id||`activity-${t+1}`);if(i.includes(a))return`<section class="cf-card tone-danger"><p class="text-sm">Cycle detected for activity "${G(a)}".</p></section>`;let s=e?.data||{},c=``;if(e?.type===`tab_group`){let e=Array.isArray(s.tabs)?s.tabs:[];c=`
...
`):``};e.forEach(e=>{l.push({id:String(e?.id||``).trim().toLowerCase(),html:t(e)})})}let u=e=>{let t=String(e||``).trim().toLowerCase();if(!t)return``;let n=l.find(e=>e.id===t);return!n&&t===`activities`&&(n=l.find(e=>e.id.includes(`activit`))),!n&&t===`additional`&&(n=l.find(e=>e.id.includes(`additional`))),n||=l.find(e=>e.id&&t.includes(e.id)),n?.html||``},d=e=>(Array.isArray(e)?e:[]).map((e,t)=>{let n=String(e?.title||``).trim()||`Resource ${t+1}`,r=String(e?.description||``).trim(),i=Zt(e?.url),a=i&&!i.startsWith(`#`)?` target="_blank" rel="noopener noreferrer"`:``;return`
              <article class="cf-card cf-card--flat">
...
`)||`<p class="cf-muted text-sm">No tools configured.</p>`}</div>
    ...
    `};return{html:`
    <style>
      ${cn.map(e=>`.cf-theme-${e}{${g[e]||g.dark_cards}}`).join(`
`)}
      ${`
      .cf-page {
        --cf-r-sm: 10px;
  ...
  `,css:``,script:`${on()}\n${hn()}`}}const _n=[`deck`,`finlit`,`coursebook`,`toolkit_dashboard`];function vn(e){return String(e||``).trim().toLowerCase()}function yn(e){return _n.includes(vn(e))}function J(e){let t=Number.parseInt(e,10);return Number.isFinite(t)?t:null}function Y(e){let t=e&&typeof e==`object`?e:{},n={},r=J(t.colSpan),i=J(t.row),a=J(t.col),o=J(t.x),s=J(t.y),c=J(t.w),l=J(t.h);return r!=null&&(n.colSpan=r),i!=null&&(n.row=i),a!=null&&(n.col=a),o!=null&&(n.x=o),s!=null&&(n.y=s),c!=null&&(n.w=c),l!=null&&(n.h=l),n}function bn(e){let t=e&&typeof e==`object`?e:{};return{composerLayout:R(t.composerLayout),activityLayouts:Object.entries(t.activityLayouts&&typeof t.activityLayouts==`object`?t.activityLayouts:{}).reduce((e,[t,n])=>{let r=String(t||``).trim();return r&&(e[r]=Y(n)),e},{})}}function xn(e,t=`deck`){let n=vn(e);if(yn(n))return n;let r=vn(t);return yn(r)?r:`deck`}function Sn(e,t){let n=R(e);return{composerLayout:n,activityLayouts:B(t,{maxColumns:n.maxColumns,mode:n.mode}).reduce((e,t)=>{let n=String(t?.id||``).trim();return n&&(e[n]=Y(t?.layout)),e},{})}}function Cn(e,{activities:t=[]}={}){let n=e&&typeof e==`object`?e:{},r=new Set((Array.isArray(t)?t:[]).map(e=>String(e?.id||``).trim()).filter(Boolean));return Object.entries(n).reduce((e,[t,n])=>{let i=vn(t);if(!yn(i))return e;let a=bn(n),o=Object.entries(a.activityLayouts||{}).reduce((e,[t,n])=>(r.size>0&&!r.has(t)||(e[t]=Y(n)),e),{});return e[i]={composerLayout:R(a.composerLayout),activityLayouts:o},e},{})}function wn(e){return bn(e)}function Tn(e,t,n,r){let i=R({mode:n,maxColumns:r}),a=bn(t),o=a&&a.composerLayout&&typeof a.composerLayout==`object`?R(a.composerLayout):i,s=a&&a.activityLayouts&&typeof a.activityLayouts==`object`?a.activityLayouts:{},c=B(e,{maxColumns:o.maxColumns,mode:o.mode}).map(e=>{let t=String(e?.id||``).trim(),n=t?s[t]:null;return!n||typeof n!=`object`?e:{...e,layout:{...e.layout||{},...Y(n)}}}),l=e=>{let t=String(e?.id||``).trim();return!!(t&&s[t])},u=B(c,{maxColumns:o.maxColumns,mode:o.mode}),d=u.map((e,t)=>l(e)?null:t).filter(e=>Number.isInteger(e));if(!d.length)return{composerLayout:o,activities:u};let f=new Set(d),p=new Set(u.map((e,t)=>t).filter(e=>!f.has(e))),m=p.size>0;if(o.mode===`canvas`){let e=m&&Array.from(p).reduce((e,t)=>{let n=u[t]?.layout||{},r=Number.parseInt(n.y,10),i=Number.parseInt(n.h,10),a=Number.isFinite(r)?Math.max(0,r):0,o=Number.isFinite(i)?Math.max(1,i):4;return Math.max(e,a+o)},0)||0;return{composerLayout:o,activities:B(u.map((t,n)=>{if(!f.has(n))return t;let r=t?.layout||{},i=Number.parseInt(r.w,10),a=Number.parseInt(r.h,10),o=Number.isFinite(i)?Math.max(1,i):Math.max(1,Number.parseInt(r.colSpan,10)||1),s=Number.isFinite(a)?Math.max(1,a):4,c={...t,layout:{...r||{},x:0,y:e,w:o,h:s,col:1,row:e+1,colSpan:o}};return e+=s,c}),{maxColumns:o.maxColumns,mode:o.mode})}}let h=m?Array.from(p).reduce((e,t)=>{let n=Number.parseInt(u[t]?.layout?.row,10),r=Number.isFinite(n)?Math.max(1,n):1;return Math.max(e,r)},1)+1:1;return{composerLayout:o,activities:B(u.map((e,t)=>{if(!f.has(t))return e;let n=e?.layout||{},r={...e,layout:{...n||{},row:h,col:1,x:0,y:h-1}};return h+=1,r}),{maxColumns:o.maxColumns,mode:o.mode})}}function X(e){if(e==null)return e;try{if(typeof structuredClone==`function`)return structuredClone(e)}catch{}try{return JSON.parse(JSON.stringify(e))}catch{return e}}function En(e){let t=e&&typeof e==`object`?e:{},n={};return t.colSpan!=null&&(n.colSpan=t.colSpan),t.breakpoints&&typeof t.breakpoints==`object`&&(n.breakpoints=X(t.breakpoints)),n}function Dn(e){let t=e&&typeof e==`object`?e:{};return{type:String(t.type||``).trim()||`content_block`,data:X(t.data||{}),style:X(t.style||{}),behavior:X(t.behavior||{}),layout:En(t.layout)}}function On(e,t,{prefix:n=`cmp`}={}){let r=String(e||``).trim()||`Untitled Component`,i=new Date().toISOString();return{id:`${n}-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,name:r,createdAt:i,updatedAt:i,activity:Dn(t)}}function kn(e,{fallbackPrefix:t=`cmp`}={}){if(!e||typeof e!=`object`)return null;let n=Dn(e.activity);return String(n.type||``).trim()?{id:String(e.id||`${t}-${Date.now()}-${Math.random().toString(36).slice(2,8)}`).trim(),name:String(e.name||``).trim()||`Untitled Component`,createdAt:String(e.createdAt||e.updatedAt||``).trim()||new Date().toISOString(),updatedAt:String(e.updatedAt||e.createdAt||``).trim()||new Date().toISOString(),activity:n}:null}function An(e,t={}){return(Array.isArray(e)?e:[]).map(e=>kn(e,t)).filter(Boolean)}function jn(e){if(!e||typeof e!=`object`||!e.component||typeof e.component!=`object`)return null;let t=String(e.component.sourceId||``).trim();return t?{sourceId:t,sourceName:String(e.component.sourceName||``).trim()||`Course Component`,linked:e.component.linked!==!1,linkedAt:String(e.component.linkedAt||``).trim()||``,sourceUpdatedAt:String(e.component.sourceUpdatedAt||``).trim()||``}:null}function Mn(e){let t=kn(e);return t?{sourceId:t.id,sourceName:t.name,linked:!0,linkedAt:new Date().toISOString(),sourceUpdatedAt:t.updatedAt||t.createdAt||``}:null}function Nn(e,t){let n=e&&typeof e==`object`?{...e}:{},r=Mn(t);return r&&(n.component=r),n}function Pn(e,t,{name:n}={}){let r=kn(e);if(!r)return null;let i=String(n||r.name||``).trim()||`Untitled Component`;return{...r,name:i,updatedAt:new Date().toISOString(),activity:Dn(t)}}function Fn(e,t){let n=jn(e);if(!n)return{linked:!1,stale:!1,missingSource:!1,sourceEntry:null,link:null};let r=An(t).find(e=>e.id===n.sourceId)||null,i=String(r?.updatedAt||r?.createdAt||``).trim();return{linked:!!n.linked,stale:!!(r&&i!==String(n.sourceUpdatedAt||``).trim()),missingSource:!r,sourceEntry:r,link:n}}function In(e){if(!e||typeof e!=`object`||!e.component)return e;let t={...e};return delete t.component,t}function Ln(e,t){let n=jn(e);return!!(n?.sourceId&&String(n.sourceId)===String(t||``).trim())}function Rn(e,t,{preserveLayout:n=!0}={}){let r=kn(t);if(!r||!Ln(e,r.id))return{changed:!1,activity:e};let i=e&&typeof e==`object`?e:{},a=jn(i),o=Dn(r.activity),s=Mn(r),c={...i,...o,id:i.id||o.id,layout:n&&i.layout&&typeof i.layout==`object`?X(i.layout):En(o.layout),component:a?.linkedAt?{...s,linkedAt:a.linkedAt}:s},l=JSON.stringify(i)!==JSON.stringify(c);return{changed:l,activity:l?c:e}}function zn(e,t,n={}){let r=!1,i=0,a=(Array.isArray(e)?e:[]).map(e=>{let a=Rn(e,t,n);return a.changed?(r=!0,i+=1,a.activity):e});return{changed:r,count:i,activities:r?a:Array.isArray(e)?e:[]}}function Bn(e,t,n={}){let r=!1,i=0,a=(Array.isArray(e)?e:[]).map(e=>{if(!Array.isArray(e?.activities)||e.activities.length===0)return e;let a=zn(e.activities,t,n);return a.changed?(r=!0,i+=a.count,{...e,activities:a.activities}):e});return{changed:r,count:i,modules:r?a:Array.isArray(e)?e:[]}}function Vn(e){return{...e?.layout&&typeof e.layout==`object`?e.layout:{}}}function Z(e,t){return{...e,layout:{...Vn(e),...t}}}function Q(e){let t=Vn(e),n=Math.max(1,Number.isInteger(t.w)?t.w:Number.isInteger(t.colSpan)?t.colSpan:1),r=Math.max(1,Number.isInteger(t.h)?t.h:4);return{x:Math.max(0,Number.isInteger(t.x)?t.x:0),y:Math.max(0,Number.isInteger(t.y)?t.y:0),w:n,h:r}}function Hn(e){let t=Vn(e);return{row:Math.max(1,Number.isInteger(t.row)?t.row:1),col:Math.max(1,Number.isInteger(t.col)?t.col:1),colSpan:Math.max(1,Number.isInteger(t.colSpan)?t.colSpan:1)}}function $(e,t,n){let r=new Set((Array.isArray(t)?t:[]).filter(e=>Number.isInteger(e)));return r.size<=1?e:(Array.isArray(e)?e:[]).map((e,t)=>r.has(t)?n(e,t):e)}function Un(e,t,n){let r=(Array.isArray(e)?e:[]).filter(e=>Number.isInteger(e));if(!r.length)return[];let i=r.includes(t)?t:r[0];return[i,...r.filter(e=>e!==i).sort(n)]}function Wn(e,t,n,r=`left`){let i=e?.[n];if(!i)return e;let a=Q(i);return $(e,t,e=>{let t=Q(e);return r===`left`?Z(e,{x:a.x}):r===`right`?Z(e,{x:Math.max(0,a.x+a.w-t.w)}):r===`top`?Z(e,{y:a.y}):r===`bottom`?Z(e,{y:Math.max(0,a.y+a.h-t.h)}):e})}function Gn(e,t,n=`horizontal`){let r=(Array.isArray(t)?t:[]).filter(e=>Number.isInteger(e));if(r.length<=2)return e;let i=[...r].sort((t,r)=>{let i=Q(e[t]),a=Q(e[r]);return n===`vertical`?i.y-a.y||i.x-a.x:i.x-a.x||i.y-a.y}),a=Q(e[i[0]]),o=Q(e[i[i.length-1]]),s=i.reduce((t,r)=>{let i=Q(e[r]);return t+(n===`vertical`?i.h:i.w)},0),c=n===`vertical`?Math.max(0,o.y+o.h-a.y):Math.max(0,o.x+o.w-a.x),l=Math.max(0,(c-s)/(i.length-1)),u=n===`vertical`?a.y:a.x,d=new Map;return i.forEach(t=>{let r=Q(e[t]);n===`vertical`?(d.set(t,{y:Math.round(u)}),u+=r.h+l):(d.set(t,{x:Math.round(u)}),u+=r.w+l)}),$(e,i,(e,t)=>Z(e,d.get(t)||{}))}function Kn(e,t,n,r=`width`){let i=e?.[n];if(!i)return e;let a=Q(i);return $(e,t,e=>r===`height`?Z(e,{h:a.h}):Z(e,{w:a.w,colSpan:a.w}))}function qn(e,t,n){let r=e?.[n];if(!r)return e;let i=Q(r),a=Un(t,n,(t,n)=>{let r=Q(e[t]),i=Q(e[n]);return r.y-i.y||r.x-i.x||t-n}),o=new Map,s=i.y;return a.forEach(t=>{let n=Q(e[t]);o.set(t,{x:i.x,y:s}),s+=n.h}),$(e,a,(e,t)=>Z(e,o.get(t)||{}))}function Jn(e,t,n){let r=e?.[n];if(!r)return e;let i=Hn(r);return $(e,t,e=>Z(e,{colSpan:i.colSpan,w:i.colSpan}))}function Yn(e,t,n){let r=e?.[n];if(!r)return e;let i=Hn(r),a=Un(t,n,(t,n)=>{let r=Hn(e[t]),i=Hn(e[n]);return r.row-i.row||r.col-i.col||t-n}),o=new Map;return a.forEach((e,t)=>{o.set(e,{row:i.row+t,col:i.col})}),$(e,a,(e,t)=>Z(e,o.get(t)||{}))}function Xn(e,t=`activity`){return String(e||``).trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||t}function Zn(e){return e&&typeof e==`object`?{...e}:e}function Qn(e,t){return`${Xn(e,`activity`)}-${Date.now()}-${t+1}-${Math.random().toString(36).slice(2,6)}`}function $n(e={},t=0){return String(e.title||e.caption||e.label||``).trim()||(String(e.url||``).trim().split(`/`).pop()?.split(`?`)[0]?.split(`#`)[0]||``).replace(/\.[a-z0-9]{2,8}$/i,``).replace(/[-_]+/g,` `).replace(/\s+/g,` `).trim()||`Image ${t+1}`}function er(e){let t=Array.isArray(e)?e:[],n=new Set,r=!1,i=0;return{activities:t.map((e,t)=>{let a=Zn(e),o=String(e?.id||``).trim();return!o||n.has(o)?(a.id=Qn(e?.type,t),r=!0,i+=1,n.add(a.id),a):(n.add(o),a)}),changed:r,fixedCount:i}}function tr(e){let t=Array.isArray(e)?e:[],n=!1,r=0;return{activities:t.map((e,t)=>{if(e?.type!==`image_block`)return e;let i=e?.data&&typeof e.data==`object`?e.data:{};return String(i.alt||``).trim()?e:(n=!0,r+=1,{...e,data:{...i,alt:$n(i,t)}})}),changed:n,fixedCount:r}}function nr(e,{breakpoint:t=`mobile`}={}){let n=Array.isArray(e)?e:[],r=!1,i=0;return{activities:n.map(e=>{let n=e?.layout&&typeof e.layout==`object`?e.layout:null;if(!n)return e;let a=n.breakpoints&&typeof n.breakpoints==`object`?n.breakpoints:{},o=a[t]&&typeof a[t]==`object`?a[t]:null;if(o&&Object.keys(o).length>0)return e;let s=Number.isInteger(n?.x)||Number.isInteger(n?.w)||Number.isInteger(n?.h);return(Number.isInteger(n?.colSpan)?n.colSpan:Number.isInteger(n?.w)?n.w:1)<=1?e:(r=!0,i+=1,{...e,layout:{...n,breakpoints:{...a,[t]:s?{...o||{},x:0,w:1}:{...o||{},col:1,colSpan:1}}}})}),changed:r,fixedCount:i}}const rr=[{value:`simple`,label:`Simple`},{value:`advanced`,label:`Advanced`}].map(e=>e.value),ir=[{value:`focus`,label:`Focus`,settings:{previewWidth:62,previewHeight:900,builderHeight:720,builderCellWidth:220,lockBuilderScale:!0}},{value:`balanced`,label:`Balanced`,settings:{previewWidth:55,previewHeight:900,builderHeight:760,builderCellWidth:220,lockBuilderScale:!0}},{value:`canvas`,label:`Canvas`,settings:{previewWidth:45,previewHeight:1e3,builderHeight:860,builderCellWidth:240,lockBuilderScale:!1}}];function ar(e,t=`simple`){let n=String(e||``).trim().toLowerCase();return n&&rr.includes(n)?n:t}export{x as $,Rt as A,kt as B,Cn as C,qt as D,Kt as E,Vt as F,B as G,j as H,mt as I,tt as J,R as K,_t as L,Bt as M,Wt as N,Yt as O,zt as P,se as Q,U as R,wn as S,gn as T,et as U,dt as V,ft as W,ct as X,ot as Y,De as Z,zn as _,nr as a,ie as at,Tn as b,Kn as c,Yn as d,T as et,Nn as f,An as g,Fn as h,tr as i,le as it,Gt as j,Xt as k,Jn as l,In as m,ar as n,he as nt,Wn as o,Ee as ot,On as p,ut as q,er as r,re as rt,Gn as s,ir as t,ge as tt,qn as u,Bn as v,xn as w,Sn as x,Pn as y,vt as z};